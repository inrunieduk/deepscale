...
document.getElementById('select-imageR')
.onclick = function() {
    photoFile.click()
}
...
cropButton.onclick = () => {
    ...
    //enviarButton.style.display = 'initial'
}
...
// Enviar
//const enviardButton = document.getElementById('enviar')
//enviarButton.onclick = function() {
 //   const e = document.createElement('e')
 //   e.enviar = photoName + '-cropped.png';
